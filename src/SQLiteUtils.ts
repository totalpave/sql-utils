...
/**
 * Utility functions meant for SQLite usage.
 */
export class SQLiteUtils {
    ...
    public static toValue(x: number | string | Date | boolean | null | undefined): string {
        ...
        if (x === null || x === undefined) {
            ...
            out = SQLiteUtils.toValue(SQLiteUtils.toDatetime(x)); // To double quote it for drop-in
        }
            ...
            throw new Error('Unhandled type in SQLiteUtils.toValue');
        }
